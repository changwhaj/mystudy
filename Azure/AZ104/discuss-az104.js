...
function setSequence(seq, vlist) {
    ...
    setCookie("AZ104"+seq, vlist, {secure: true, 'expires': expDate});
}
...
var passwd = getCookie('passaz104');
...
if (passwd == undefined) {
    ...
    if (passwd.toUpperCase() == PASSKEY) {
        ...
        expDate.setMonth(expDate.getMonth() + 1);
        expDate = expDate.toUTCString();
        setCookie('passaz104', passwd, {secure: true, 'expires': expDate});
    }
}
passwd = getCookie('passaz104');
